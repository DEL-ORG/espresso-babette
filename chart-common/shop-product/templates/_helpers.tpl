...
*/}}
{{- define "shop-product.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "shop-product.fullname" .) .Values.serviceAccount.name }}
{{- else }}
